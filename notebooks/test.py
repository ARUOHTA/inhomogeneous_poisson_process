...
x_vals = [130.0000 + 0.01*i for i in range(5)]  # 130.0000, 130.0100, 130.0200, 130.0300, 130.0400
y_vals = [ 30.0000 + 0.01*j for j in range(5)]  #  30.0000,  30.0100,  30.0200,  30.0300,  30.0400
...
test_points_boundary = [
    ...
    (130.0050, 30.0049999, (1, 0)),     # x=130.0050 は(0, 0)メッシュの右境界・左境界スレスレ
    (130.0049999, 30.0050, (0, 1)),     # y=30.0050 は(0,0)メッシュの上境界と(0,1)の下境界ギリギリ
