...
from bayesian_statistics.utils import lamda, generate_IPP, multi_pgdraw_vectorized


def gibbs_sampling(X: np.ndarray, y: np.ndarray, z: np.ndarray, b: np.ndarray, B: np.ndarray, SIM: int, batch_size: int, output_file: str) -> None:
